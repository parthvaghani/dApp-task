    ...
    try {
      ...
      if (error instanceof Error) {
        ...
        if (errorMessage.includes("insufficient")) {
          ...
          toast.error(
            "Transaction simulation failed. This usually means the smart wallet needs more gas or the transaction parameters are invalid."
          );
        ...
        <div className="space-y-2 text-sm">
          <div className="flex items-center justify-between">
            ...
            <code className="text-gray-800 bg-gray-100 px-2 py-1 rounded">
              0x1a9Ea0628868298b0e252D249deBb9ff91795341
            </code>
          </div>
          <div className="flex items-center justify-between">
